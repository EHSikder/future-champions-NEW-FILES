          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'var(--space-4)' }}>
              ...
              <div className="form-group">
                <label className="form-label">{t('profile_name') || 'Full Name'} <span style={{ color: 'var(--color-vibrant-orange)' }}>*</span></label>
                <input
                  type="text"
              ...
              <div className="form-group">
                <label className="form-label">
                  Display Name <span style={{ color: 'var(--color-vibrant-orange)' }}>*</span>
              ...
              {/* Company Name */}
              <div className="form-group">
                <label className="form-label">{t('Company Name') || 'Company Name'} <span style={{ color: 'var(--color-vibrant-orange)' }}>*</span></label>                
                <input
                  type="text"
                  className="form-input"
              ...
              {/* Mobile Number */}
              <div className="form-group">
                <label className="form-label">Mobile Number <span style={{ color: 'var(--color-vibrant-orange)' }}>*</span></label>
                <input
                  type="tel"
                  className="form-input"
            ...
            <div className="form-group" style={{ marginTop: 'var(--space-4)' }}>
              <label className="form-label">
                Where did you hear about us? <span style={{ color: 'var(--color-vibrant-orange)' }}>*</span>
              </label>
                ...
                {HEAR_ABOUT_OPTIONS.map(opt => (
                  <button
                    ...
                    style={{
                      padding: '10px 14px',
                      borderRadius: '14px',
                      border: formData.hearAbout === opt.value ? '2px solid var(--color-golden-yellow)' : '1px solid var(--color-border)',
                      background: formData.hearAbout === opt.value ? 'rgba(212,168,67,0.12)' : 'var(--color-surface-3)',
                      color: formData.hearAbout === opt.value ? 'var(--color-golden-yellow)' : 'var(--color-text-primary)',
            ...
            <div className="form-group" style={{ marginTop: 'var(--space-6)' }}>
              <label className="form-label" style={{ textAlign: 'center', display: 'block', fontSize: '1.2rem', marginBottom: 'var(--space-2)' }}>
                {t('profile_team') || 'Select Favourite Team'} <span style={{ color: 'var(--color-vibrant-orange)' }}>*</span>
              </label>
                  ...
                  .map(team => (
                    <div
                      ...
                      style={{
                        ...
                        cursor: 'pointer',
                        borderRadius: 'var(--radius-md)',
                        background: formData.favoriteTeamId === team.id ? 'var(--color-golden-yellow)' : 'var(--color-surface-3)',
                        color: '#111',
